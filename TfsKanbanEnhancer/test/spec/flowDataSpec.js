describe("FlowReport", function() {
  ...
  it("should be generated", function() {
    ...
    expect(jsonEncode(flowReport)).toBe(jsonEncode([[ 'Id', 'Title', 'url', 'lane', 'first', 'last' ], [ '3', 'CR 1', 'https://paddelkraft.visualstudio.com/DefaultCollection/tfsDataCollection/_workitems#_a=edit&id=3', 'Dev DONE', '1970-01-01 03:46', '1970-01-01 03:46' ], [ '', '', '', '', '', '' ], [ '4', 'AT 1', 'https://paddelkraft.visualstudio.com/DefaultCollection/tfsDataCollection/_workitems#_a=edit&id=4', 'ToDo', '1970-01-01 03:46', '1970-01-01 03:46' ], [ '', '', '', '', '', '' ], [ '9', 'BL ticket 1', 'https://paddelkraft.visualstudio.com/DefaultCollection/tfsDataCollection/_workitems#_a=edit&id=9', 'Dev IP', '1970-01-01 03:46', '1970-01-01 03:46' ], [ '', '', '', '', '', '' ]]));
  });
...
describe("FlowDataGrid", function() {
  ...
  it("should be generated", function() {
    boardData.addSnapshot(snapshot);
    var flowGrid = new FlowDataGrid(boardData.flowData , boardData.getLaneHeaders());
